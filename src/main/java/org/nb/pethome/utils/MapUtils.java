...
public class MapUtils {
    ...
    public static void main(String[] args) {
        try {
            // 1、根据地址获取经纬度
            Map<String, String> lonAndLat = getLonAndLat("浙江省杭州市滨江区江汉路1515号", "429b0517f6d231fe34e2a2c9173c85a4");
            System.out.println("转换后经纬度为：" + lonAndLat);

            // 2、根据经纬度获取地址
            String formattedAddress = getAMapByLngAndLat("110.204798", "32.201000", "429b0517f6d231fe34e2a2c9173c85a4");
